<!-- skills: Java, JavaScript, TypeScript, Python, C, React, HTML, CSS, Bootstrap, Tailwind, Node.js, PostgreSQL, MySQL, Git, Docker, Linux, NGINX, Full Stack, Developer -->
...
<p align="center">
  ...
  &nbsp;·&nbsp;
  <a href="https://github.com/raiksha/raiksha/blob/main/README.md">✦ versión en español</a>
</p>
...
<p align="center">
  Full stack developer in training, focused on building things that make sense end to end.<br>
  Student of <strong>Full Stack Java at <a href="https://chile.generation.org/">Generation Chile</a></strong> · CS50x · self-taught by conviction.<br>
  I care about well-designed systems, infrastructure, and software built with people in mind — not just machines.<br>
  Currently preparing to start university in 2027.
</p>
...
<div align="center">
  <table>
    ...
    <tr>
      ...
      <td>Personal portfolio hosted on a DigitalOcean Droplet with Docker + NGINX</td>
...
<!-- Fun fact -->
<h2 align="center">⚡ in five words</h2>
<p align="center"><em>solid logic</em> ( ◡̀_◡́)ᕤ<br><em>questionable syntax memory</em><br>╮ (. ❛ ᴗ ❛.) ╭</p>
